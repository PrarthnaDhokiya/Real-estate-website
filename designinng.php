...
<div class="inside-banner">
  <div class="container"> 
    <span class="pull-right"><a href="#">Home</a> / Interiour-Designing</span>
    <h2>Interiour-Designing</h2>
</div>
</div>
<!-- banner -->
...
<div class="row">
  <div class="col-lg-8  col-lg-offset-2 col-sm-12">
      ...
      <div class="row">
        ...
        <div class="col-lg-7 col-sm-7 "><h4> om Furnituring</h4><p><br></p></div>
      ...
      <div class="row">
        ...
        <div class="col-lg-7 col-sm-7 "><h4>aakansha furniture</h4></div>
